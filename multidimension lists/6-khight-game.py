def check_for_king(kings):  # chek for most aggressive
    m_king = tuple()        # king, and return it
    max_hit_kings = 0
    for king in kings:
        hits_kings = 0
...
n_board = int(input())
kings = []
for r in range(n_board):  # get positions of kings
    line = input()
...
# while True:
#     position = position_of_killer(matrix)
#     if position:
